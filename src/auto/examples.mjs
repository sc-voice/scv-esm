const EXAMPLES = {
  ...
  "de": [
    ...
    "alt werden m[uü]ss",
    "andere ermuntert, das Gleiche zu tun",
    ...
    "Heiligtümer",
    "heißt es so",
    "Heiterkeit als auch Klarsicht",
    "Heiterkeit und Klarsicht",
    ...
    "nicht unterrichten oder anleiten",
    "nicht zur Last",
    ...
    "wahrhaftig versteh.*: ‚Das ist das Leiden.‘",
    "Wahrnehmung der unattraktiven Natur",
