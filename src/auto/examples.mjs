const EXAMPLES = {
  ...
  "de": [
    ...
    "himmlische hohe und üppige Bett",
    ...
    "losgelöst",
    "Macht der Weisheit",
    "Macht über diese Entscheidungen",
    ...
    "Suche nach den vorteilhaften Folgen",
    "süße Spitze",
    "tatsächlich gibt",
    ...
    "Unbeständigkeit aller Bedingungen beobachte",
  ...
  "en": [
    ...
    "heat is generated",
    "heavenly high and luxurious bed",
